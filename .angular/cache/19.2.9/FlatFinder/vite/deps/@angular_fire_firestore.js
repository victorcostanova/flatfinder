...
var __PRIVATE_LruScheduler = class {
  ...
  Ir(e) {
    __PRIVATE_logDebug(Dt, `Garbage collection scheduled in ${e}ms`), this.Tr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, () => __async(this, null, function* () {
      this.Tr = null;
      try {
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  ...
  shutdown() {
    return __async(this, null, function* () {
      ...
      yield this.Li.runTransaction("shutdown", "readwrite", [W, Ve], (e) => {
...
function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  return __async(this, null, function* () {
    ...
    e.asyncQueue.enqueueRetryable(() => __async(this, null, function* () {
      __PRIVATE_logDebug(jt, "Retrying IndexedDB access"), yield n(), e.aa.delete(
        1
        /* OfflineCause.IndexedDbFailed */
...
function __PRIVATE_ensureWatchStream(e) {
  ...
  }), e.ua.push((t) => __async(this, null, function* () {
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.Ta = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    yield __PRIVATE_fillWritePipeline(e)) : (yield e.Ta.stop(), e.oa.length > 0 && (__PRIVATE_logDebug(jt, `Stopping write stream with ${e.oa.length} pending writes`), e.oa = []));
  }))), e.Ta;
}
...
var FirestoreClient = class {
  constructor(e, t, n, r, i) {
    this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, (e2) => __async(this, null, function* () {
      __PRIVATE_logDebug(Zt, "Received user=", e2.uid), yield this.authCredentialListener(e2), this.user = e2;
...
function __PRIVATE_setOnlineComponentProvider(e, t) {
  return __async(this, null, function* () {
    ...
    __PRIVATE_logDebug(Zt, "Initializing OnlineComponentProvider"), yield t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
function __PRIVATE_ensureOfflineComponents(e) {
  return __async(this, null, function* () {
    ...
    } else __PRIVATE_logDebug(Zt, "Using default OfflineComponentProvider"), yield __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
    return e._offlineComponents;
  });
}
function __PRIVATE_ensureOnlineComponents(e) {
  return __async(this, null, function* () {
    return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(Zt, "Using user provided OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(Zt, "Using default OnlineComponentProvider"), yield __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
  });
}
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
    ...
    n.yu(), e.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
      ...
      i2.yu(), e2.asyncQueue.enqueueAndForget(() => __async(this, null, function* () {
